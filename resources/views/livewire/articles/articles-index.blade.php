<div class="flex flex-center -mx-3 mb-5">
  <div class="grid justify-items-center">
      <button class="btn-donate mt-20 ml-auto mr-8" href="/article/create" wire:navigate>
          Ajouter New Article
      </button>
      <div class="snap-center flex justify-center">
        @if (session('status')) 
        <div class="bg-green-500 flex justify-center mr-20 items-center p-4 text-white rounded-lg">
            {{ session('status') }}
        </div>
        @endif 
      </div>
    ...
    @endif   
     {{-- end alert danger --}}  
      ...
      <div class="w-full max-w-full px-3 mb-6 mx-auto">
          <div class="bg-[#c6d1da] relative flex-[1_auto] flex flex-col xl:grid grid-cols- l4 xs:grid-cols-2 g:grid-cols-4 break-words min-w-0 bg-clip-border rounded-[.95rem] m-5">
              <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl font-bold border-stone-200 bg-light/30">
                  {{-- start Titre Table --}}
                  ...
                  <div class="block py-8 pt-6 px-9">
                      <div class="overflow-x-auto">
                          <table class="bg-[#c6d1da] text-black my-0 align-middle">
                              {{-- start Name Table  --}}
                                      ...
                                      <td class="p-3 pr-0 text-center ml-10">
                                          <form class="flex justify-center items-center">
                                              {{-- <button class="edit-button w-10"> --}}
                                                  <a href="/article/{{ $article->id }}/edit" class="edit-button w-10" wire:navigate>
                                              ...
                                              {{-- </button> --}}
                                              <div class="m-2">
                                                  <button class="group relative flex h-10 w-10 flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-red-400 bg-red-600 hover:bg-red-600" type="button" wire:click="deleteArticle({{ $article->id }})" wire:confirm="Are you sure you want to delete this Article?">
